...
This document is a guide to contributing to funnel
...
You'll need to build funnel locally in order to start editing code.

To install funnel from source, clone the GitHub
...
To contribute to funnel, send us pull requests.
For those new to contributing, check out GitHub's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the funnel
...
If you'd like to add a new feature to funnel, please do propose your
...
- Read the funnel source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/tschm/funnel/issues),
...
funnel tests live in the directory `tests`,
